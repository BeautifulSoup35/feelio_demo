/* 우주 말랑이 (SpaceBlob) — 평행우주 가이드 캐릭터. 전역 등록판. */
(function () {
  ...
  function SpaceBlob({ size = 220, speaking = false }) {
      ...
      <div style={{ width: S, display: "flex", flexDirection: "column", alignItems: "center", fontFamily: "system-ui,-apple-system,sans-serif" }}>
        ...
        <div style={{ position: "relative", width: S, height: S }}>
          <svg width="100%" height="100%" viewBox="0 0 200 200" style={{ display: "block", overflow: "visible" }}>
            ...
            <g style={{ animation: `sb-float 6s ease-in-out infinite` }}>
