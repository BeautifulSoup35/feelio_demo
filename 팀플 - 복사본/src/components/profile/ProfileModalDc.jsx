    ...
    >
        ...
        <MainScreen>
          <Header>
            ...
            <div css={{ flex: 1 }}>
              ...
              <div css={{ fontSize: 13, color: 'var(--sub)' }}>seoyeon@feelio.app · {provider} 계정</div>
            </div>
      ...
      {view === 'profileEdit' && (
        <Screen>
          ...
          <Field value="seoyeon@feelio.app" disabled />
      ...
      {view === 'account' && (
        <Screen>
          ...
          <div css={{ background: 'var(--card)', border: '1px solid var(--line)', borderRadius: 14, padding: '16px 18px', marginBottom: 10 }}><div css={{ fontSize: 12, color: 'var(--sub)', fontWeight: 700 }}>이메일</div><div css={{ fontSize: 14.5, fontWeight: 700, marginTop: 3 }}>seoyeon@feelio.app</div></div>
